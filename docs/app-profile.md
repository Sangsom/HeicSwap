...
> **Minimum iOS**: 26.0
> **Status**: In development (scaffold + tasks 1.1–1.3 · 2.1–2.2 · 3.1–3.5 · 4.1 · 5.1 complete; Convert queue built — options 5.2 / convert 5.3 next)
...
├── Features/       # Convert (4.1 shell + 5.1 queue — `ConvertView`/`ConvertViewModel`, `QueueGridView` 4-col grid with "+N" overflow + safelight glow, pure `QueueLayout` math, `ConvertRoute`), Settings (placeholder, pushed destination), Import (3.5 — PhotosImportButton, FilesImportButton; the standalone ImportView harness was removed once 5.1's real queue replaced it)
