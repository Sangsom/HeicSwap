...
> **Minimum iOS**: 26.0
> **Status**: In development (scaffold + tasks 1.1–1.3 · 2.1–2.2 · 3.1–3.5 · 4.1 · 5.1–5.3 complete; batch convert + "developing" reveal built — results sheet 5.4 next)
